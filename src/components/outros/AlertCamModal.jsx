                ...
                <div className={styles.modal_overlay} >
                    <div className={styles.modal_conteudo}>
                        <div className={styles.modal_cabecalho} >
                            <img width="94" height="94" src="https://img.icons8.com/3d-fluency/94/warning-shield.png" alt="warning-shield" />
                        </div>
                        <div className={styles.modal_corpo}>
                            {mensagens.length > 0 ? (
                                ...
                                <p className={styles.sem_mensagens}>Nenhuma mensagem recebida ainda.</p>
                            )}
                        </div>
                        <div className={styles.modal_rodape}>
                            <button onClick={fecharModal} className={styles.btn_fechar_rodape}>
                                Fechar
                            </button>
                        </div>
                    </div>
