...
const VeiculosData = () => {
    ...
    useEffect(() => {
        const fetchVeiculo = async () => {
            try {
                ...
                const filteredResults = data.filter(veiculo =>veiculo.unidade!=='' && veiculo.valor_meio_acesso!=='') //Filtrando os dados obtidos. As coluna unidade e valor_meio_acesso devem conter dados 
    ...
    return (
        ...
        <p className={styles.p_txt}>Abaixo pode-se visualizar as quantidades de veiculo por marca que fazem parte do estoque das lojas que se encontram nas dependencias do Auto Shopping:</p>
